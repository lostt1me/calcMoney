...
export const ToolTip = () => {
    ...
    function onClickToolTip(value: boolean): void {
        setActiveTooltip(value);
        let tooltipState: string;
        value? tooltipState='show' : tooltipState='hide';
        $(function () {
            ($('[data-toggle="tooltip"]') as any).tooltip(
                tooltipState
            )
    ...
    function onHoverToolTip(value: boolean): void {
        let tooltipState: string;
        value? tooltipState='show' : tooltipState='hide';
        $(function () {
            ($('[data-toggle="tooltip"]') as any).tooltip(
    ...
    const infoCircle = (
        <svg className="bi bi-info-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="grey" xmlns="http://www.w3.org/2000/svg" 
            onClick={() => onClickToolTip(true)} onMouseOver={() => onHoverToolTip(true)} onMouseOut={() => onHoverToolTip(false)}>
    ...
    const xCricle = (
        <svg className="bi bi-x-circle" width="1em" height="1em" viewBox="0 0 16 16" fill="grey" xmlns="http://www.w3.org/2000/svg" onClick={() => onClickToolTip(false)}>
            <path fillRule="evenodd" d="M8 15A7 7 0 108 1a7 7 0 000 14zm0 1A8 8 0 108 0a8 8 0 000 16z" clipRule="evenodd"/>
